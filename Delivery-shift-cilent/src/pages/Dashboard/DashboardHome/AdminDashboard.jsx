...
const statusIcons = {
    ...
    rider_assigned: <FaMotorcycle className="text-5xl text-info" />,
    delivered: <FaCheckCircle className="text-5xl text-success" />,
    in_transit: <FaShippingFast className="text-5xl text-warning" />,
    not_collected: <FaBoxOpen className="text-5xl text-error" />,
...
export default function AdminDashboard() {
    ...
    return (
        ...
        <div className="p-8">
            <h1 className="text-3xl font-bold mb-6 text-center">Parcel Delivery Summary</h1>
            ...
            <div className=" bg-base-100 p-4">
                ...
                <h2 className="text-xl font-bold mb-4 text-center mt-6">Delivery Status</h2>
